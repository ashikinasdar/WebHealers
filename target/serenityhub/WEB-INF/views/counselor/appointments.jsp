                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach items="${appointments}" var="appt">
                                        ...
                                        <div class="appointment-card">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div class="d-flex align-items-center">
                                                    <div
                                                        class="session-icon session-${appt.sessionType.toString().toLowerCase()} me-3">
                                                        <c:choose>
                                                ...
                                                <span
                                                    class="badge-status badge-${appt.status.toString().toLowerCase()}">
                                                    ${appt.status}
                                                </span>
                                            </div>
                                            ...
                                            <div class="d-flex gap-2">
                                                <c:choose>
                                                    <c:when test="${appt.status == 'PENDING'}">
                                                        <form
                                                            action="${pageContext.request.contextPath}/counselor/appointment/${appt.appointmentId}/approve"
                                                        ...
                                                        <form
                                                            action="${pageContext.request.contextPath}/counselor/appointment/${appt.appointmentId}/decline"
                                                            method="post" style="flex: 1;">
                                                    ...
                                                    <c:when test="${appt.status == 'APPROVED'}">
                                                        ...
                                                        <button type="button" class="btn btn-primary btn-sm flex-fill"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#linkModal${appt.appointmentId}">
                                                            <i class="fas fa-video me-1"></i>Add Meet Link
                                                        </button>
                                                    </c:when>
                                                </c:choose>
                                    ...
                                    <div class="modal fade" id="completeModal${appt.appointmentId}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form
                                                    action="${pageContext.request.contextPath}/counselor/appointment/${appt.appointmentId}/complete"
                                                    method="post">
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <label class="form-label">Session Notes</label>
                                                            <textarea class="form-control" name="counselorNotes"
                                                                rows="5"
                                                                placeholder="Enter your notes about this counseling session..."
                                                                required></textarea>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <small class="text-muted">
                                                            ...
                                                            <fmt:formatDate value="${appt.createdAt}"
                                    ...
                                    <div class="modal fade" id="linkModal${appt.appointmentId}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Add Google Meet Link</h5>
                                                    <button type="button" class="btn-close"
                                                        data-bs-dismiss="modal"></button>
                                                </div>
                                                <form
                                                    action="${pageContext.request.contextPath}/counselor/appointment/${appt.appointmentId}/add-link"
                                                    method="post">
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            <label class="form-label">Google Meet Link</label>
                                                            <input type="url" class="form-control" name="meetingLink"
                                                                value="${appt.meetingLink}"
                                                                placeholder="https://meet.google.com/xxx-xxxx-xxx"
                                                                required>
                                                            <small class="text-muted">
                                                                Student will use this link to join the session
                                                            </small>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
