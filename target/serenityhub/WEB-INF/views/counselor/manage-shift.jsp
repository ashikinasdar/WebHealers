            ...
            <div class="col-md-8 mx-auto">
                <div class="shift-card">
                    ...
                    <div class="alert alert-${counselor.available ? 'success' : 'secondary'} mb-4">
                        <h6 class="mb-2">
                            <span class="status-indicator status-${counselor.available ? 'available' : 'unavailable'}"></span>
                            Current Status: <strong>${counselor.available ? 'AVAILABLE' : 'UNAVAILABLE'}</strong>
                        </h6>
                        <c:if test="${counselor.available && not empty counselor.shiftMeetingLink}">
                            <p class="mb-0">
                                <small>Active Meeting Link: <a href="${counselor.shiftMeetingLink}" target="_blank">${counselor.shiftMeetingLink}</a></small>
                            </p>
                        </c:if>
                    </div>
                    ...
                    <form action="${pageContext.request.contextPath}/counselor/shift/update" method="post">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="isAvailable" value="true" 
                                           ${counselor.available ? 'checked' : ''} 
                                           onchange="toggleLinkField(this.checked)">
                        ...
                        <div class="mb-4" id="linkField" style="display: ${counselor.available ? 'block' : 'none'};">
                        ...
                        <div class="alert alert-warning">
                            ...
                            <strong>Note:</strong> When you set your status to "Available", students will be able to see and access your meeting link in the counselor directory.
                        </div>
