          ...
          <div class="tab-content" id="assessmentTabContent">
            ...
            <div class="tab-pane fade show active" id="results" role="tabpanel">
              ...
              <div class="filter-buttons">
                ...
                <button class="btn btn-sm btn-outline-success filter-btn" data-filter="NORMAL">
                  Normal
                </button>
                <button class="btn btn-sm btn-outline-warning filter-btn" data-filter="MILD">
                  Mild
                </button>
                <button class="btn btn-sm btn-outline-orange filter-btn" data-filter="MODERATE">
                  Moderate
                </button>
                <button class="btn btn-sm btn-outline-danger filter-btn" data-filter="SEVERE">
                  Severe
                </button>
                <button class="btn btn-sm btn-outline-dark filter-btn" data-filter="EXTREMELY_SEVERE">
                  Extremely Severe
                </button>
              </div>
                ...
                <c:choose>
                  ...
                  <c:otherwise>
                    <c:forEach items="${results}" var="result">
                      <div class="col-md-6 result-item" data-severity="${result.overallSeverity}">
                        <div class="result-card">
                          <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                              <h6 class="mb-1">${result.studentName}</h6>
                              <small class="text-muted">${result.assessmentName}</small>
                            </div>
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                              ...
                              <fmt:formatDate value="${result.attemptedAt}" pattern="MMM dd, yyyy" />
                            </small>
                      ...
                      <div class="modal fade" id="resultModal${result.resultId}" tabindex="-1">
                    ...
                    <c:forEach items="${assessmentTypes}" var="type">
                      <div class="col-md-6">
                        <div class="assessment-card">
                          ...
                          <div class="row mb-3">
                            <div class="col-md-6">
                              <small class="text-muted"><i class="fas fa-question-circle me-1"></i>Total
                                Questions:</small>
                              <strong class="ms-2">${type.totalQuestions}</strong>
                            </div>
                            <div class="col-md-6">
                              <small class="text-muted"><i class="fas fa-calculator me-1"></i>Scoring:</small>
                          ...
                          <form
                            ...
                            <button type="submit"
                              ...
                              <i class="fas ${type.active ? 'fa-eye-slash' : 'fa-eye'} me-1"></i>
        ...
        <div class="modal fade" id="createTypeModal" tabindex="-1">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <form action="${pageContext.request.contextPath}/counselor/assessment/type/create" method="post">
                <div class="modal-body">
                  <div class="mb-3">
                    <label class="form-label">Assessment Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="name" placeholder="e.g., PHQ-9, GAD-7, DASS-21"
                      required />
                    <small class="text-muted">Choose a clear, recognizable name for this assessment</small>
                  </div>

                  <div class="mb-3">
                    <label class="form-label">Description <span class="text-danger">*</span></label>
                    <textarea class="form-control" name="description" rows="3"
                      placeholder="Describe what this assessment measures..." required></textarea>
                    <small class="text-muted">This will be shown to students when they select an
                      assessment</small>
                  </div>

                  <div class="mb-3">
                    <label class="form-label">Scoring Method <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="scoringMethod"
                      placeholder="e.g., Sum scores, Sum and multiply by 2" required />
                    <small class="text-muted">Explain how the assessment is scored</small>
                  </div>

                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="isActive" value="true" id="isActiveCheck"
                      checked />
