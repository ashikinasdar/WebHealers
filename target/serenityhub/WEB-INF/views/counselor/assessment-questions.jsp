...
<head>
    ...
    <style>
        ...
        .category-depression { background: #dbeafe; color: #1e40af; }
        .category-anxiety { background: #fef3c7; color: #92400e; }
        .category-stress { background: #fee2e2; color: #991b1b; }
        .order-badge {
            background: #e0e7ff;
            color: #3730a3;
            padding: 4px 10px;
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <div class="mb-2">
                                            ...
                                            <span class="category-badge category-${question.category.toLowerCase()}">
                                                ${question.category}
                                            </span>
                                        </div>
                        ...
                        <div class="modal fade" id="editModal${question.assessmentQuestionId}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="${pageContext.request.contextPath}/counselor/assessment/question/${question.assessmentQuestionId}/edit" 
                                          method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="category" required>
                                                    <option value="DEPRESSION" ${question.category == 'DEPRESSION' ? 'selected' : ''}>Depression</option>
                                                    <option value="ANXIETY" ${question.category == 'ANXIETY' ? 'selected' : ''}>Anxiety</option>
                                                    <option value="STRESS" ${question.category == 'STRESS' ? 'selected' : ''}>Stress</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
    ...
    <div class="modal fade" id="addQuestionModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="${pageContext.request.contextPath}/counselor/assessment/question/create" method="post">
                    <input type="hidden" name="assessmentTypeId" value="${assessmentType.assessmentTypeId}">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Question Text</label>
