...
<head>
    ...
    <style>
        ...
        .badge-severe { background: #fed7aa; color: #9a3412; }
        .badge-extremely_severe { background: #fee2e2; color: #991b1b; }
        .brand-section {
            padding: 30px 25px;
            text-align: center;
                ...
                <c:forEach items="${assessmentHistory}" var="result">
                    <div class="history-card">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="text-end">
                                <span class="badge-severity badge-${result.overallSeverity.toString().toLowerCase()}">
