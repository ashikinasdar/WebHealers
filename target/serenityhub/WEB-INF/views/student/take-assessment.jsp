...
<head>
    ...
    <style>
        ...
        .badge-depression { background: #dbeafe; color: #1e40af; }
        .badge-anxiety { background: #fef3c7; color: #92400e; }
    ...
    <div class="main-content">
        ...
        <div class="instructions-card">
            ...
            <p class="mb-2">
                ...
                over the <strong>past week</strong>. There are no right or wrong answers. Be honest with yourself.
            </p>
            <div class="info-box">
        ...
        <!-- Assessment Form -->
        <form action="${pageContext.request.contextPath}/student/assessment/${assessmentType.assessmentTypeId}/submit" 
                ...
                <div class="question-card" data-question-id="${question.assessmentQuestionId}">
                    ...
                    <div class="option-container">
                        <label class="option-label">
                            <input type="radio" 
                                   name="q_${question.assessmentQuestionId}" 
                                   value="0" 
