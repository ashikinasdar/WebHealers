...
<head>
    ...
    <title>Create Thread - SerenityHub Forum</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <h3 class="mb-4">
                <i class="fas fa-pen-fancy me-2" style="color: #667eea;"></i>
                Create New Discussion
            </h3>

            <div class="info-box">
                <i class="fas fa-info-circle me-2" style="color: #667eea;"></i>
                <strong>Forum Guidelines:</strong> Be respectful, supportive, and constructive. 
                Share your experiences and insights to help fellow students. Remember, this is a safe space for everyone.
            </div>

            <form action="${pageContext.request.contextPath}/student/forum/create" method="post" id="createThreadForm">
                <!-- Thread Title -->
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted">
                        ...
                        Tip: Be clear and detailed. The more context you provide, the better responses you'll receive.
                    </small>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="anonymous-info" id="anonymousInfo">
                        ...
                        <small>
                            Your identity will be hidden from other users. Only administrators can see anonymous post authors 
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <a href="${pageContext.request.contextPath}/student/forum" class="btn btn-outline-secondary">
    ...
    <script>
        ...
        function toggleAnonymousInfo() {
            const checkbox = document.getElementById('isAnonymous');
            const info = document.getElementById('anonymousInfo');
