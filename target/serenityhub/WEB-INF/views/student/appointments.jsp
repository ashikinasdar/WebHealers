                  ...
                  >
                    <div>
                      ...
                      <small class="text-muted"
                        >${appointment.counselorSpecialization}</small
                      >
                    </div>
                    <span
                      class="badge-status badge-${appointment.status.toString().toLowerCase()}"
                    >
                      ${appointment.status}
                    </span>
                  </div>
    ...
    <div class="modal fade" id="bookModal" tabindex="-1">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form
            action="${pageContext.request.contextPath}/student/appointment/book"
            method="post"
          >
            <div class="modal-body">
              <div class="mb-3">
                <label class="form-label"
                  >Select Counselor <span class="text-danger">*</span></label
                >
