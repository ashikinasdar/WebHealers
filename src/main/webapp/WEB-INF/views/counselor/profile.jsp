      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="profile-card">
            ...
            <!-- Edit Profile Form -->
            <form
              action="${pageContext.request.contextPath}/counselor/profile/update"
              method="post"
            >
...
${counselor.bio}</textarea
        ...
        <div class="col-md-4">
          ...
          <div class="profile-card">
            ...
            <form
              action="${pageContext.request.contextPath}/counselor/profile/change-password"
              method="post"
            >
              <div class="mb-3">
