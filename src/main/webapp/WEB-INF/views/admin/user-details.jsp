          ...
          <div class="detail-card">
            <div class="profile-header">
              ...
              <div>
                ...
                <c:choose>
                  <c:when test="${user.active}">
                    <form action="${pageContext.request.contextPath}/admin/user/${user.userId}/deactivate" method="post"
                      style="display: inline">
                      <button type="submit" class="btn btn-warning" onclick="return confirm('Deactivate this user?')">
                        <i class="fas fa-ban me-2"></i>Deactivate
                      </button>
                    </form>
                  </c:when>
                  <c:otherwise>
                    <form action="${pageContext.request.contextPath}/admin/user/${user.userId}/activate" method="post"
                      style="display: inline">
              ...
              <div class="col-md-6">
                <div class="info-row">
                  ...
                  <div class="info-value">
                    ...
                    <fmt:formatDate value="${user.createdAt}" pattern="MMMM dd, yyyy 'at' HH:mm" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                  ...
                  <div class="info-value">
                    ...
                    <c:choose>
                      <c:when test="${not empty user.lastLogin}">
                        <fmt:formatDate value="${user.lastLogin}" pattern="MMMM dd, yyyy 'at' HH:mm" />
                      </c:when>
                ...
                <div class="col-md-6">
                  <div class="info-row">
                    ...
                    <div class="info-value">
                      ...
                      <c:choose>
                        <c:when test="${not empty student.studentNumber}">${student.studentNumber}</c:when>
                        <c:otherwise><span class="text-muted">Not provided</span></c:otherwise>
                      </c:choose>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="info-row">
                    ...
                    <div class="info-value">
                      ...
                      <c:choose>
                        <c:when test="${not empty student.faculty}">${student.faculty}</c:when>
                        <c:otherwise><span class="text-muted">Not provided</span></c:otherwise>
                      </c:choose>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="info-row">
                    ...
                    <div class="info-value">
                      ...
                      <c:choose>
                        <c:when test="${student.yearOfStudy > 0}">Year ${student.yearOfStudy}</c:when>
                        <c:otherwise><span class="text-muted">Not provided</span></c:otherwise>
                      </c:choose>
                    </div>
                  </div>
