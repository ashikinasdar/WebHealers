        ...
        <div class="main-content">
          ...
          <div class="content-card">
            ...
            <div class="filter-tabs">
              ...
              <a href="${pageContext.request.contextPath}/admin/users?type=student"
                class="filter-tab ${filterType == 'student' ? 'active' : ''}">
                <i class="fas fa-user-graduate me-2"></i>Students
              </a>
              <a href="${pageContext.request.contextPath}/admin/users?type=counselor"
                class="filter-tab ${filterType == 'counselor' ? 'active' : ''}">
                <i class="fas fa-user-tie me-2"></i>Counselors
              </a>
              <a href="${pageContext.request.contextPath}/admin/users?type=admin"
                    ...
                    <c:otherwise>
                      <c:forEach items="${users}" var="user">
                        <tr>
                          ...
                          <td>${user.email}</td>
                          <td>
                            <span class="badge-status badge-${user.userType.toString().toLowerCase()}">
                              ${user.userType}
                            </span>
                          </td>
                          <td>
                          ...
                          <td>
                            ...
                            <a href="${pageContext.request.contextPath}/admin/user/${user.userId}/edit"
                              class="btn btn-sm btn-warning btn-action" title="Edit">
                              <i class="fas fa-edit"></i>
                            </a>
                            <c:choose>
                              <c:when test="${user.active}">
                                <form action="${pageContext.request.contextPath}/admin/user/${user.userId}/deactivate"
                                  method="post" style="display: inline">
                                  <button type="submit" class="btn btn-sm btn-secondary btn-action" title="Deactivate"
                              ...
                              <c:otherwise>
                                <form action="${pageContext.request.contextPath}/admin/user/${user.userId}/activate"
                                  method="post" style="display: inline">
                                  <button type="submit" class="btn btn-sm btn-success btn-action" title="Activate"
                            ...
                            <form action="${pageContext.request.contextPath}/admin/user/${user.userId}/delete"
                              method="post" style="display: inline">
