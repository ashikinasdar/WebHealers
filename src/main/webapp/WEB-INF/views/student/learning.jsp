          ...
          <c:when test="${empty modules}">
            <div class="col-12">
              <div class="text-center py-5">
                ...
                <h5 class="text-muted">No learning modules available yet</h5>
              </div>
            </div>
          </c:when>
          <c:otherwise>
                    ...
                    <div class="ms-3 flex-grow-1">
                      ...
                      >
                        ...
                        <div class="text-center">
                          <div
                            class="progress-ring"
                            style="--progress: ${module.progress_percentage * 3.6}deg;"
                          >
                      ...
                      >
                        ...
                        <a
                          href="${pageContext.request.contextPath}/student/module/${module.module_id}"
                          class="btn btn-start btn-sm"
                        >
                          <c:choose>
                            <c:when
                              test="${module.progress_status == 'COMPLETED'}"
                            >
                              <i class="fas fa-check me-2"></i>Review
                            </c:when>
                            <c:when
                              test="${module.progress_status == 'IN_PROGRESS'}"
                            >
