...
<div class="sidebar">
    <nav class="nav flex-column mt-4">
        ...
        <a class="nav-link" href="${pageContext.request.contextPath}/student/learning">Learning</a>
        <a class="nav-link" href="${pageContext.request.contextPath}/student/appointments">Appointments</a>
        <a class="nav-link active" href="${pageContext.request.contextPath}/student/chatbot">Chatbot</a>
        <a class="nav-link" href="${pageContext.request.contextPath}/student/profile">Profile</a>
