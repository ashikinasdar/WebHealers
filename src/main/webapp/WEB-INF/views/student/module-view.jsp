                    ...
                    <div class="main-content">
                        <div class="module-header">
                            ...
                            <c:set var="progressValue"
                                value="${empty progress.progressPercentage ? 0 : progress.progressPercentage}" />
                        ...
                        <div class="module-content-wrapper">
                            ...
                            <div class="content-section" id="moduleContent">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <h3>Introduction</h3>
                                        <p>Welcome to this learning module on ${module.title}. This course is designed
                                            to provide you with essential knowledge and practical skills in the area of
                                            ${module.category}.</p>

                                        <h3>Key Concepts</h3>
                                        <p>Throughout this module, we'll explore several important concepts that will
                                            help you develop a deeper understanding of the subject matter.</p>

                                        <h3>Practical Applications</h3>
                                        <p>Now that we've covered the theory, let's look at how you can apply these
                                            concepts in real-world situations.</p>

                                        <h3>Summary</h3>
                                        <p>Congratulations on completing this module! Remember that learning is a
                        ...
                        <div class="action-buttons">
                            ...
                            <div>
                                <form
                                    action="${pageContext.request.contextPath}/student/module/${module.moduleId}/complete"
